.text
# lê uma data (dia, mês e ano) e informe o dia da semana
# (três primeiras letras) em que cai a data. 
# Congru�ncia de Zeller para encontrar dia da semana no calend�rio Juliano e Gregoriano
main:	addi $v0 $0 5
	syscall
	add $t0 $0 $v0 # dia
	addi $v0 $0 5
